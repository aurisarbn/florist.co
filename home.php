...
<section class="home">
   ...
   <div class="content">
      ...
      <p>Kami hanya menjual produk yang berkualitas tinggi, semua desain dan bahan yang dipakai merupakan bahan premium kualitas impor. </p>
      <a href="about.php" class="btn">Tertarik?</a>
   </div>
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="" method="POST" class="box">
         ...
         <input type="submit" value="tambahkan ke favorit" name="add_to_wishlist" class="option-btn">
   ...
   <div class="more-btn">
      <a href="shop.php" class="option-btn">tampilkan lebih banyak</a>
   </div>
