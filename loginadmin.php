...
if(isset($_POST['submit'])){
   ...
   $select_karyawan = mysqli_query($conn, "SELECT * FROM `karyawan` WHERE email = '$email' AND password = '$pass'") or die('query failed');
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <p>lupa kata sandi? <a href="forgot_password.php">ubah kata sandi</a></p>
