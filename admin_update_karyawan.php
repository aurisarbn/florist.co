...
$select_karyawan = mysqli_query($conn, "SELECT * FROM `karyawan` WHERE id = '$update_id'") or die('query failed');
        ...
        <div class="container mt-5">
            <form method="POST" action="#">
                <table class="table table-bordered">
                    <tr>
                        <th>Nama</th>
                        <td><input type="text" class="form-control" value="<?php echo $fetch_karyawan['name']; ?>" name="update_u_name"></td>
                    </tr>
                    <tr>
                        <th>Tempat Tanggal Lahir</th>
                        <td><input type="text" class="form-control" value="<?php echo $fetch_karyawan['birthplace']; ?>" name="update_u_birthplace"></td>
                    </tr>
                    <tr>
                        <th>Email</th>
                        <td><input type="text" class="form-control" value="<?php echo $fetch_karyawan['email']; ?>" name="update_u_email"></td>
                    </tr>
                    <tr>
                        <th>No Telepon</th>
                        <td><input type="text" class="form-control" value="<?php echo $fetch_karyawan['no_hp']; ?>" name="update_u_no_hp"></td>
                    </tr>
                    <tr>
                        <th>Alamat</th>
                        <td><input type="text" class="form-control" value="<?php echo $fetch_karyawan['address']; ?>" name="update_u_address"></td>
                    </tr>
                    <tr>
                        <th>Keahlian</th>
                        <td><input type="text" class="form-control" value="<?php echo $fetch_karyawan['keahlian']; ?>" name="update_u_keahlian"></td>
                    </tr>
                    <tr>
                        <th>Jabatan</th>
                        <td><input type="text" class="form-control" value="<?php echo $fetch_karyawan['jabatan']; ?>" name="update_u_jabatan"></td>
                    </tr>
                </table>
                <input type="submit" value="Edit Pengguna" name="update_karyawan" class="option-btn">
