...
<section class="display-order">
    ...
    ?>    
    <p> <?php echo $fetch_cart['name'] ?> <span>(<?php echo 'IDR '.$fetch_cart['price'].'K '.' x '.$fetch_cart['quantity']  ?>)</span> </p>
    <?php
        }
        }else{
    ...
    ?>
    <div class="grand-total">total : <span>IDR <?php echo $grand_total; ?>K </span></div>
</section>
...
<section class="checkout">
    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>No.Telp :</span>
                <input type="number" name="number" min="0" placeholder="No">
            </div>
            <div class="inputBox">
                <span>Email :</span>
            ...
            <div class="inputBox">
                ...
                <select name="method">
                    ...
                    <option value="paypal">ovo/shopeepay</option>
                    <option value="paytm">indomaret</option>
                </select>
            </div>
            <div class="inputBox">
                <span>Alamat Jalan :</span>
                <input type="text" name="flat" placeholder="e.g. jl. melati">
            </div>
            <div class="inputBox">
                <span>Patokan Rumah :</span>
                <input type="text" name="street" placeholder="e.g.  blok B no.2">
            </div>
            <div class="inputBox">
                <span> Kota :</span>
                <input type="text" name="city" placeholder="e.g. Jakarta Selatan">
            </div>
            <div class="inputBox">
                <span>Kecamatan :</span>
                <input type="text" name="state" placeholder="e.g. Jatipadang">
            </div>
            <div class="inputBox">
                <span>Negara :</span>
