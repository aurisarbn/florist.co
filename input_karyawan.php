...
if (isset($_POST['add_user'])) {
    ...
    $add_u_birthplace = mysqli_real_escape_string($conn, $_POST['add_u_birthplace']);
    ...
    $query = "INSERT INTO karyawan (name, birthplace, email, no_hp, address, keahlian, jabatan)
              VALUES ('$add_u_name','$add_u_birthplace' ,'$add_u_email', '$add_u_no_hp', '$add_u_address', '$add_u_keahlian', '$add_u_jabatan')";
    ...
    <form method="POST" action="#">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><input type="text" class="form-control" value="" name="add_u_birthplace"></td>
            </tr>
            <tr>
                <th>Email</th>
